...
module.exports = {
  ...
  "_spec": "axios@^0.21.1",
  "_where": "D:\\PortFolio Project\\stripe_client",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51JZTWQSIUZLasS08a1DaAMFWRUXD9FvGT6Y0OkIaZwhnNVvrd9JsJ940equ3RQ1EWUyJ0yGoGZEcpnQPR9vP73R300uWPqJWYu'); // DOM Elements
...
console.log(pay); // Necessary Variables
...
var cardExpiryComplete;
var cardCvcComplete; // Execute Function

createStripeElements(); // Stripe Create Elements
...
function createStripeElements() {
  ...
  cardCvcElement = elements.create('cardCvc'); // Mount Elements

  cardNumberElement.mount(cardNumber);
  cardExpiryElement.mount(cardExpiry);
  cardCvcElement.mount(cardCvc);
  console.log(cardNumberElement, 'cardNumberElement'); // Error Handling
...
function handlePaymentFlow(_x) {
  return _handlePaymentFlow.apply(this, arguments);
...
function _handlePaymentFlow() {
  _handlePaymentFlow = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
...
function _addCard() {
  _addCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var userId, _yield$axios$get, data, _yield$stripe$confirm, error, setupIntent, body, _yield$axios$patch, _data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            userId = '61d1b099cb78f9f25f2857b2';
            _context2.next = 4;
            return _axios.default.get("http://localhost:5050/api/v1/setup-intent/".concat(userId));

          case 4:
            _yield$axios$get = _context2.sent;
            data = _yield$axios$get.data;
            console.log(data, 'data check'); // seti_1KIXVzSIUZLasS08kJySF8Jg_secret_KyUUKlij70bKNheq0Bzq7T38XwKzeW8;
          ...
          case 9:
            ...
            _context2.next = 17;
            return _axios.default.patch("http://localhost:5050/api/v1/update-customer/".concat(userId), body);
          ...
          case 19:
            ...
            console.log(setupIntent, 'setupIntent response'); // Create Subscription

            _context2.next = 23;
            return createSubscription(userId, setupIntent.payment_method);
          ...
          case 25:
            ...
            console.log(_context2.t0, 'api error check');
...
function createSubscription(_x2, _x3) {
  return _createSubscription.apply(this, arguments);
} // price_1KIcL8SIUZLasS08u9VOUXFU;


function _createSubscription() {
  _createSubscription = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(userId, pm) {
    var priceId, _yield$axios$post, data;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            priceId = 'price_1KIcL8SIUZLasS08u9VOUXFU';
            _context3.next = 4;
            return _axios.default.post("http://localhost:5050/api/v1/createSubscription/".concat(userId, "?priceId=").concat(priceId, "&paymentMethod=").concat(pm));
          ...
          case 9:
            ...
            console.log(_context3.t0.message, 'from sub error');
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","axios":"../node_modules/axios/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
